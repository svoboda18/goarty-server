...
urlpatterns = [
    ...
    re_path(
        r"^articles/(?P<pk>[^/]+)/(?P<relation>[^/]+)/?$",
        RelationAddDeleteView.as_view(),
    ),
    ...
    path(
        "incrementCharsModified/",
        views.increment_chars_modified,
        name="increment_chars_modified",
    ),
]
